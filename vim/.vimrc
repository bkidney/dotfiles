...
function! Newfile(dir, name)
	...
	let l:name = join(split(a:name), "-")
	let l:fName = l:date . "_" . l:name . ".md"
	call append( line(".") - 1, "[" . a:name . "](" . l:fName . ")")
endfunction
command! -nargs=1 Newfile call Newfile(<args>)
...
nnoremap <Leader>ww :e ~/Nextcloud/docs/notebook/index.md<cr>
